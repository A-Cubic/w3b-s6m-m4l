...
import styles from './EuropeAndAmericaHousue.less';
...
class EuropeAndAmericaHousue extends PureComponent {
  componentDidMount() {
    this.init()
  }
  init(){
      ...
      <div>
        <div style={{textAlign:'center',marginBottom:'45px',marginTop:'25px'}}>
          <span style={{fontSize:'22px',color:'#555',fontWeight:'bold'}}>
              —————<em style={{margin:'0 25px',fontStyle:'normal'}}>欧美畅销单品</em>—————
          </span>
        </div>
        <Row>
      ...
      >
        ...
        <div className={styles.coverCardList}>
          <div style={{textAlign:'center',marginBottom:'45px'}}>
            <span style={{fontSize:'22px',color:'#555',fontWeight:'bold'}}>
              —————<em style={{margin:'0 25px',fontStyle:'normal'}}>欧美畅销品牌</em>—————
            </span>
          </div>
...
export default EuropeAndAmericaHousue;
